...
;(function( $, window, document, undefined ) {
	...
	FileInput.prototype = {
		...
		_build: function () {
			...
			this.container = $( '<div class="fileinput-holder upload-button-controller" style="position: relative;"></div>' )
				...
				.append( $( '<span class="fileinput-btn btn" type="button" ' + 
					'style="display:block; overflow: hidden; top: 0; right: 0; cursor: pointer;"></span>' )
