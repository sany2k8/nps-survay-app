...
/*
	...
	{
		$model=new User;
        $base_path = Yii::app()->basePath."/../images/profile-images/";
		...
		if(isset($_POST['User']))
		{
            ...
            if($uploaded_file and $model->validate())
            {
                ...
                //create thumb
                Yii::import("ext.EPhpThumb.EPhpThumb");//image thumb generator library import

                $thumb=new EPhpThumb();
                $thumb->init(); //this is needed
                //chain functions
                $thumb->create(Yii::app()->basePath."/../images/profile-images/".$main_image)->resize(35)->save(Yii::app()->basePath."/../images/profile-images/".$main_image);//this will make thumb from uploaded image
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['User']))
		{
            ...
            if($uploaded_file and $model->validate())
            {
                ...
                //chain functions
                $thumb->create(Yii::app()->basePath."/../images/profile-images/".$main_image)->resize(35)->save(Yii::app()->basePath."/../images/profile-images/".$main_image);//this will make thumb from uploaded image
                GenericProperties::setUserImage($main_image,$model->id);
