...
class Survay extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'purpose_served' => 'Was your purpose Served?',
			'heard_abt_tonic' => 'Where have you heard about Tonic?',
			'knowledge' => 'Knowledge',
			'behavior' => 'Behavior',
			...
			'com_from_tonic_auth' => 'Communication from Tonic/Authority',
			'dc_others_comment' => 'DC Others/Comment',
			'refer_to_ff' => 'Refer To FF',
			'score' => 'Score',
			'category' => 'Category',
			'reason_be_score' => 'Reason Behind Score',
