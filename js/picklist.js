	...
	$.widget("awnry.pickList",
		{
			...
			options:
			{
				...
				// Control classes
				addAllClass:                "pickList_addAll btn",
				addClass:                   "pickList_add btn",
				removeAllClass:             "pickList_removeAll btn",
				removeClass:                "pickList_remove btn",
				...
				sourceListLabel:            "All User List",
				sourceListLabelClass:       "pickList_sourceListLabel",
				targetListLabel:            "Queue User",
			...
			_filterHandler: function(e) {
				...
				filter.next().children( 'li' ).show().filter( function() {
			...
			_buildSourceList: function()
			{
				...
				var filterer = $('<input type="text" id="pickListFilterInput"/>')
					.addClass('pickList_sourceListFilterer')
				...
				$(document).on(
					'keyup',
					'#pickListFilterInput',
					$.proxy( self._filterHandler, self )
				);
					//.on( 'keyup',  );
			...
			_buildTargetList: function()
			{
				...
				var filterer = $('<input type="text" id="pickListFilterTarget"/>')
					.addClass('pickList_targetListFilterer')
					.addClass('form-control');
